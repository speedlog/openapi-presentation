package pl.wyszomierski.mariusz.openapi.code_first;
...
import pl.wyszomierski.mariusz.openapi.code_first.blog.post.EditablePost;
import pl.wyszomierski.mariusz.openapi.code_first.blog.post.Post;
...
class CodeFirstApplicationTests {
	...
	void testCrudOperations() {
		...
		Assertions.assertEquals(expectedTitle, createdPost.getTitle());
		Assertions.assertEquals(expectedDescription, createdPost.getDescription());
		...
		Assertions.assertEquals(newTitleExpected, afterUpdate.getTitle());
		Assertions.assertEquals(newDescriptionExpected, afterUpdate.getDescription());
